...
func first(ctx context.Context, urls []string) (*result, error) {
	// in buffered channels, as long as there is space in the channel
	// the sender can send even if the receiver is not ready/there to receive
